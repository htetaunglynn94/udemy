...
TCL_CC='/croot/tk_1755243784563/_build_env/bin/aarch64-conda-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/root/git/udemy/da_bootcamp_BtoA/python/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/root/git/udemy/da_bootcamp_BtoA/python/venv'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -isystem /root/git/udemy/da_bootcamp_BtoA/python/venv/include -fdebug-prefix-map=/croot/tk_1755243784563/work=/usr/local/src/conda/tk-8.6.15 -fdebug-prefix-map=/root/git/udemy/da_bootcamp_BtoA/python/venv=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /root/git/udemy/da_bootcamp_BtoA/python/venv/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-rpath,/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -Wl,-rpath-link,/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -L/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/croot/tk_1755243784563/_build_env/bin/aarch64-conda-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/croot/tk_1755243784563/work/tcl8.6.15/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/root/git/udemy/da_bootcamp_BtoA/python/venv/include'
...
# compiled.
TCL_SRC_DIR='/croot/tk_1755243784563/work/tcl8.6.15'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/root/git/udemy/da_bootcamp_BtoA/python/venv/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/croot/tk_1755243784563/work/tcl8.6.15/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1755243784563/work/tcl8.6.15/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/root/git/udemy/da_bootcamp_BtoA/python/venv/lib/libtclstub8.6.a'
