...
# installed.
TK_PREFIX='/root/git/udemy/da_bootcamp_BtoA/python/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/root/git/udemy/da_bootcamp_BtoA/python/venv'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/croot/tk_1755243784563/work/tk8.6.15/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/root/git/udemy/da_bootcamp_BtoA/python/venv/include'
...
# compiled.
TK_SRC_DIR='/croot/tk_1755243784563/work/tk8.6.15'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/croot/tk_1755243784563/work/tk8.6.15/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/root/git/udemy/da_bootcamp_BtoA/python/venv/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/croot/tk_1755243784563/work/tk8.6.15/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/root/git/udemy/da_bootcamp_BtoA/python/venv/lib/libtkstub8.6.a'
